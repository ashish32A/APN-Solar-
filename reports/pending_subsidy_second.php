...
try {
    $stmt = $pdo->prepare("
        ...
        p.total_amount, p.due_amount, i.remarks AS install_remarks, i.updated_at AS install_updated
        FROM customers c
...
$pageTitle = 'Pending Customer Second Subsidy';
include __DIR__ . '/../views/partials/header.php';
?>

<div style="padding: 15px;">
    <h2 style="font-size: 1.5rem; margin-bottom: 15px; font-weight: normal;">
        Pending Customer Second Subsidy:-<?= $totalRecords > 0 ? "($totalRecords)" : "" ?>
    </h2>
        ...
        <table class="table table-bordered table-striped" style="font-size: 0.9rem;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <?php if ("Pending Customer Second Subsidy" !== "Pending Online Installations"): ?>
                    ...
                    <?php if (strpos("<th>Total Amount</th><th>Due Amount</th><th>Remarks</th><th>Updated date</th>", "<th>Email</th>") === false): ?>
                    ...
                    <th>Total Amount</th><th>Due Amount</th><th>Remarks</th><th>Updated date</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= number_format((float)$r["total_amount"], 2) ?></td><td><?= number_format((float)$r["due_amount"], 2) ?></td><td><?= $r["install_remarks"] ?></td><td><?= substr($r["install_updated"] ?? "", 0, 10) ?></td>
                    <td>
                        <a href="/APN-Solar/customers/customer_status_update.php?id=<?= $r['id'] ?>&back=<?= str_replace('.php', '', 'pending_subsidy_second.php') ?>" class="btn btn-warning btn-sm" style="background-color: #ffc107; border-color: #ffc107; color: #212529;">
                            Edit
                        </a>
                    </td>
                </tr>
...
function exportToExcel() {
    ...
    a.download = 'Pending Customer Second Subsidy.xls';
    a.click();
}
</script>
