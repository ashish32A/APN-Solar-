...
try {
    $stmt = $pdo->prepare("
        ...
        c.email, c.account_number, c.ifsc_code, c.jan_samarth, c.remarks, c.updated_at AS c_updated_at
        FROM customers c
...
$pageTitle = 'Pending account number';
include __DIR__ . '/../views/partials/header.php';
?>

<div style="padding: 15px;">
    <h2 style="font-size: 1.5rem; margin-bottom: 15px; font-weight: normal;">
        Pending account number:-<?= $totalRecords > 0 ? "($totalRecords)" : "" ?>
    </h2>
        ...
        <table class="table table-bordered table-striped" style="font-size: 0.9rem;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <?php if ("Pending account number" !== "Pending Online Installations"): ?>
                    ...
                    <?php if (strpos("<th>Email</th><th>Bank name</th><th>Ifsc code</th><th>Branch name</th><th>J S date</th><th>Remarks</th><th>Updated date</th>", "<th>Email</th>") === false): ?>
                    ...
                    <th>Email</th><th>Bank name</th><th>Ifsc code</th><th>Branch name</th><th>J S date</th><th>Remarks</th><th>Updated date</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $r["email"] ?></td><td><?= $r["account_number"] ?></td><td><?= $r["ifsc_code"] ?></td><td></td><td><?= $r["jan_samarth"] ?></td><td><?= $r["remarks"] ?></td><td><?= substr($r["c_updated_at"] ?? "", 0, 10) ?></td>
                    <td>
                        <a href="/APN-Solar/customers/edit.php?id=<?= $r['id'] ?>&back=<?= str_replace('.php', '', 'pending_account_number.php') ?>" class="btn btn-warning btn-sm" style="background-color: #ffc107; border-color: #ffc107; color: #212529;">
                            Edit
                        </a>
                    </td>
                </tr>
...
function exportToExcel() {
    ...
    a.download = 'Pending account number.xls';
    a.click();
}
</script>
