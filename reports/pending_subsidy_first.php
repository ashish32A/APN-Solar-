...
$pageTitle = 'Pending Customer First Subsidy';
include __DIR__ . '/../views/partials/header.php';
?>

<div style="padding: 15px;">
    <h2 style="font-size: 1.5rem; margin-bottom: 15px; font-weight: normal;">
        Pending Customer First Subsidy:-<?= $totalRecords > 0 ? "($totalRecords)" : "" ?>
    </h2>
        ...
        <table class="table table-bordered table-striped" style="font-size: 0.9rem;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <?php if ("Pending Customer First Subsidy" !== "Pending Online Installations"): ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/APN-Solar/customers/customer_status_update.php?id=<?= $r['id'] ?>&back=<?= str_replace('.php', '', 'pending_subsidy_first.php') ?>" class="btn btn-warning btn-sm" style="background-color: #ffc107; border-color: #ffc107; color: #212529;">
                            Edit
                        </a>
                    </td>
                </tr>
...
function exportToExcel() {
    ...
    a.download = 'Pending Customer First Subsidy.xls';
    a.click();
}
</script>
