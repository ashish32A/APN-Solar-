...
try {
    $stmt = $pdo->prepare("
        ...
        i.invoice_no, i.installer_name, i.installation_date, i.meter_installation, i.meter_configuration, i.dcr_certificate, i.online_installer_name, i.remarks AS install_remarks, i.updated_at AS install_updated
        FROM customers c
...
$pageTitle = 'Pending Online Installations';
include __DIR__ . '/../views/partials/header.php';
?>

<div style="padding: 15px;">
    <h2 style="font-size: 1.5rem; margin-bottom: 15px; font-weight: normal;">
        Pending Online Installations:-<?= $totalRecords > 0 ? "($totalRecords)" : "" ?>
    </h2>
        ...
        <table class="table table-bordered table-striped" style="font-size: 0.9rem;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <?php if ("Pending Online Installations" !== "Pending Online Installations"): ?>
                    ...
                    <?php if (strpos("<th>Invoice No.</th><th>Installer Name</th><th>Installation Date</th><th>Meter Installation</th><th>Meter Configuration</th><th>Dcr Certificate</th><th>Online Installer</th><th>Last Updated on</th><th>Remarks</th>", "<th>Email</th>") === false): ?>
                    ...
                    <th>Invoice No.</th><th>Installer Name</th><th>Installation Date</th><th>Meter Installation</th><th>Meter Configuration</th><th>Dcr Certificate</th><th>Online Installer</th><th>Last Updated on</th><th>Remarks</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $r["invoice_no"] ?></td><td><?= $r["installer_name"] ?></td><td><?= $r["installation_date"] ?></td><td><?= $r["meter_installation"] ?></td><td><?= $r["meter_configuration"] ?></td><td><?= $r["dcr_certificate"] ?></td><td><?= $r["online_installer_name"] ?></td><td><?= substr($r["install_updated"] ?? "", 0, 10) ?></td><td><?= $r["install_remarks"] ?></td>
                    <td>
                        <a href="/APN-Solar/customers/customer_status_update.php?id=<?= $r['id'] ?>&back=<?= str_replace('.php', '', 'pending_online_installation.php') ?>" class="btn btn-warning btn-sm" style="background-color: #ffc107; border-color: #ffc107; color: #212529;">
                            Edit
                        </a>
                    </td>
                </tr>
...
function exportToExcel() {
    ...
    a.download = 'Pending Online Installations.xls';
    a.click();
}
</script>
