...
try {
    $stmt = $pdo->prepare("
        ...
        i.material_dispatch_1st, i.material_dispatch_2nd, i.installer_name, i.installation_date, i.remarks AS install_remarks, i.updated_at AS install_updated
        FROM customers c
...
$pageTitle = 'Pending Installation';
include __DIR__ . '/../views/partials/header.php';
?>

<div style="padding: 15px;">
    <h2 style="font-size: 1.5rem; margin-bottom: 15px; font-weight: normal;">
        Pending Installation:-<?= $totalRecords > 0 ? "($totalRecords)" : "" ?>
    </h2>
        ...
        <table class="table table-bordered table-striped" style="font-size: 0.9rem;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <?php if ("Pending Installation" !== "Pending Online Installations"): ?>
                    ...
                    <?php if (strpos("<th>Material Dispatch 1st</th><th>Material Dispatch 2nd</th><th>Installer Name</th><th>Installation Date</th><th>Remarks</th><th>Last Updated on</th>", "<th>Email</th>") === false): ?>
                    ...
                    <th>Material Dispatch 1st</th><th>Material Dispatch 2nd</th><th>Installer Name</th><th>Installation Date</th><th>Remarks</th><th>Last Updated on</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $r["material_dispatch_1st"] ?></td><td><?= $r["material_dispatch_2nd"] ?></td><td><?= $r["installer_name"] ?></td><td><?= $r["installation_date"] ?></td><td><?= $r["install_remarks"] ?></td><td><?= substr($r["install_updated"] ?? "", 0, 10) ?></td>
                    <td>
                        <a href="/APN-Solar/customers/customer_status_update.php?id=<?= $r['id'] ?>&back=<?= str_replace('.php', '', 'pending_installation.php') ?>" class="btn btn-warning btn-sm" style="background-color: #ffc107; border-color: #ffc107; color: #212529;">
                            Edit
                        </a>
                    </td>
                </tr>
...
function exportToExcel() {
    ...
    a.download = 'Pending Installation.xls';
    a.click();
}
</script>
