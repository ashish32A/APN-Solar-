...
$pageTitle = 'Material Dispatch One Customer List';
include __DIR__ . '/../views/partials/header.php';
?>

<div style="padding: 15px;">
    <h2 style="font-size: 1.5rem; margin-bottom: 15px; font-weight: normal;">
        Material Dispatch One Customer List:-<?= $totalRecords > 0 ? "($totalRecords)" : "" ?>
    </h2>
        ...
        <table class="table table-bordered table-striped" style="font-size: 0.9rem;">
            <thead style="background-color: #f8f9fa;">
                <tr>
                    ...
                    <?php if ("Material Dispatch One Customer List" !== "Pending Online Installations"): ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/APN-Solar/customers/customer_status_update.php?id=<?= $r['id'] ?>&back=<?= str_replace('.php', '', 'first_materials_dispatched.php') ?>" class="btn btn-warning btn-sm" style="background-color: #ffc107; border-color: #ffc107; color: #212529;">
                            Edit
                        </a>
                    </td>
                </tr>
...
function exportToExcel() {
    ...
    a.download = 'Material Dispatch One Customer List.xls';
    a.click();
}
</script>
