...
$pageTitle = 'Pending Jansamarth Customer';
...
<div style="padding: 15px;">
    <h4 style="margin-bottom: 15px; font-weight: normal;">
        Pending Jansamarth Customer:-<?= $totalRecords > 0 ? "($totalRecords)" : "(0)" ?>
    </h4>
        ...
        <table class="table table-bordered table-striped" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/APN-Solar/customers/edit.php?id=<?= $r['id'] ?>&back=<?= str_replace('.php', '', 'customer_jan_samarth_pending.php') ?>" class="btn btn-warning btn-sm" style="background-color: #ffc107; border-color: #ffc107; color: #212529; font-weight: bold; padding: 2px 10px;">
                            Edit
                        </a>
                    </td>
                </tr>
...
function exportToExcel() {
    ...
    a.download = 'Pending Jansamarth Customer.xls';
    a.click();
}
</script>
